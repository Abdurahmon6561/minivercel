 ...
 * (`--primary`, `--accent-vivid`) - never a blank box, and never a colour
...
export function BlobFallback() {
  return (
    <div
      aria-hidden="true"
      className="size-full rounded-full bg-linear-to-br from-primary/70 via-primary/40 to-accent-vivid/25 blur-2xl"
    />
  );
}
